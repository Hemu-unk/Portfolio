...
export const projects = [
  {
    ...
    summary:
      "Full-stack adaptive learning platform with ML-driven hint prediction, correctness estimation, and adaptive question selection. Flask backend, React frontend, JWT-secured REST APIs.",
  },
  {
    id: "2",
    ...
    summary:
      "Analytics model across multiple F1 seasons studying relationships between performance indicators and win probability. Full pipeline from SQLite schema to linear regression to Matplotlib visualizations.",
  },
  {
    id: "3",
    ...
    summary:
      "Agent-based disease spread simulation with movement, infection, recovery, and immunity. Random Forest and Decision Tree models predict peak infections. Deployed on AWS Elastic Beanstalk with S3 storage.",
  },
  {
    id: "4",
